...
/*
        ...
        Client c1 = clientDB.getClient(new Long(33));//pROFESSOR
        Account acc1 = accountDB.getAccount(new Long(33));

        Client c2 = clientDB.getClient(new Long(44));//Magnetto
        Account acc2 = accountDB.getAccount(new Long(44));

        Document d2 = new Document(new Long(44443333),acc2,acc1,new BigDecimal(100),"from Magnetto To Professor",new Date());

        documentDB.addDocument(d2);
